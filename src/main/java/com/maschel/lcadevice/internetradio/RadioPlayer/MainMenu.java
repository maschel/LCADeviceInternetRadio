...
import com.maschel.lcadevice.internetradio.PreferenceAgent.VolumePreferenceHandler;
...
public class MainMenu extends JFrame implements ActionListener,ChangeListener, DeviceHandlerListener, WindowListener, PlayerMenu {
	...
	private static MainMenu theMainMenu = null;

	public static MainMenu staticMain = null;
